...
## What is NOT AI agent? 
When you are using prompt to ask ChatGPT directly, for example, ask it 'please write out an essay on Topic XXX from start to end in one go'. This is not AI Agent. 
