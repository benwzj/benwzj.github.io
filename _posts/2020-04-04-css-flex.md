...
The contents of a new flex container will behave in the following way (Default way):
...
- Need to understand Three properties: `flex-grow`, `flex-shrink`, `flex-basis`. By Default, they are `flex: 0 1 auto`.
